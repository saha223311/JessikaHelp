...
tester::tester() {
  ...
  //
  QList<QStringList> result1;
  result1.push_back(QStringList() << QString::fromUtf8("тритикале") << QString::fromUtf8("1")
            << QString::fromUtf8("Германия") << QString::fromUtf8("Rimpau")
            << QString::fromUtf8("8x") << QString::fromUtf8("п/яр.")
            << QString::fromUtf8(""));
  result1.push_back(QStringList() << QString::fromUtf8("тритикале") << QString::fromUtf8("3")
            << QString::fromUtf8("Россия, Московская обл.") << QString::fromUtf8("25 АД 20")
            << QString::fromUtf8("8x") << QString::fromUtf8("яр.")
            << QString::fromUtf8(""));
  result1.push_back(QStringList() << QString::fromUtf8("тритикале") << QString::fromUtf8("5")
            << QString::fromUtf8("Россия, Московская обл.") << QString::fromUtf8("31 АД 72")
            << QString::fromUtf8("8x") << QString::fromUtf8("оз.")
            << QString::fromUtf8(""));
  result1.push_back(QStringList() << QString::fromUtf8("тритикале") << QString::fromUtf8("7")
            << QString::fromUtf8("Россия, Московская обл.") << QString::fromUtf8("АД 110")
            << QString::fromUtf8("8x") << QString::fromUtf8("оз.")
            << QString::fromUtf8(""));
  result1.push_back(QStringList() << QString::fromUtf8("тритикале") << QString::fromUtf8("9")
